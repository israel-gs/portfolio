  ...
  return (
    <section className="font-satoshi bg-dark-800 text-white py-28 px-14 lg:py-40 lg:px-20 flex justify-center gap-16 flex-wrap">
      <div className="w-full lg:w-auto">
        <h2 className="text-4xl md:text-5xl font-bold mb-8 md:mb-12">
          Get in touch
        </h2>
      ...
      <div className="flex flex-col gap-5 w-full lg:w-auto">
        <div className="flex gap-12 flex-wrap">
          <p className="mb-4 flex flex-col flex-1">
            <span className="font-bold text-2xl md:text-3xl">Email</span>
            <a
          ...
          <p className="mb-4 flex flex-col flex-1">
            <span className="font-bold text-2xl md:text-3xl">Phone</span>
            <a
